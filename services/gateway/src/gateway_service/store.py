"""Key-value store with pluggable backends — the mock government registry must survive restarts and cold starts.

Default is the dependency-free SQLite file (GATEWAY_DB; ":memory:" in tests).
